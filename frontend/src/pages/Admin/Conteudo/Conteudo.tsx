...
const Conteudo = () => {
  const [activeTab, setActiveTab] = useState<
    "apresentacao" | "informacoes" | "bonus"
  >("apresentacao");
  ...
  const [hotmartBackgroundImage, setHotmartBackgroundImage] = useState<
    string | null
  >(null);
  ...
  const handleHotmartImageUpload = async (
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL_EXPORT}/admin/conteudo/hotmart-background`,
        {
          method: "POST",
          headers: {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setHotmartCardData({
          ...
          descricao:
            data["hotmart_card_descricao"]?.valor ||
  ...
  const handleSaveHotmartCard = async () => {
    ...
    try {
      ...
      const parametros = [
        {
          chave: "hotmart_card_badge",
          valor: hotmartCardData.badge,
          nome: "Badge do Card Hotmart",
          descricao: "Texto do badge do card (ex: Mais Vendido)",
        },
        {
          chave: "hotmart_card_titulo",
          valor: hotmartCardData.titulo,
          nome: "Título do Card Hotmart",
          descricao: "Título principal do card",
        },
        {
          chave: "hotmart_card_descricao",
          valor: hotmartCardData.descricao,
          nome: "Descrição do Card Hotmart",
          descricao: "Descrição/subtítulo do card",
        },
        {
          chave: "hotmart_card_preco_label",
          valor: hotmartCardData.precoLabel,
          nome: "Label do Preço do Card",
          descricao: "Texto antes do preço (ex: A partir de)",
        },
        {
          chave: "hotmart_card_preco",
                  ...
                  <div className="section-card-header">
                    <h3>
                      <i
                        ...
                        style={{ marginRight: "0.5rem" }}
                      ></i>
                      Card Hotmart - Produtos e Cursos Exclusivos
                    </h3>
                    ...
                    {loadingHotmartCard ? (
                      ...
                      <div className="content-editor-form">
                        ...
                        <div className="content-editor-actions">
                          <button
                            className="admin-btn-secondary"
                            onClick={() => setEditingHotmartCard(false)}
                          >
                            Cancelar
                          </button>
                          <button
                            className="admin-btn-primary"
                            onClick={handleSaveHotmartCard}
                      ...
                      <div>
                        <p className="section-preview">
                          <strong>Badge:</strong> {hotmartCardData.badge}
                          <br />
                          <strong>Título:</strong> {hotmartCardData.titulo}
                          <br />
                          <strong>Descrição:</strong>{" "}
                          {hotmartCardData.descricao}
                          <br />
                        ...
                        >
                          <button
                            className="admin-btn-primary"
                            onClick={() => setEditingHotmartCard(true)}
                          >
                            <i className="fas fa-edit"></i>
                            Editar Conteúdo
                          </button>
